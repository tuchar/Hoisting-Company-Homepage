...
$cfg_basehost = 'http://www.zhuhaidiaozhuang.com/';
$cfg_cmspath = '';
$cfg_cookie_encode = 'CWhnnUW9mVvy7aL5wdL0koGTovTO';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '大竹县竹海吊装服务有限公司(大竹吊车_大竹吊装_达州吊车_达州吊装)';
$cfg_adminemail = 'hitr@foxmail.com';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '大竹吊车|大竹县吊车|达州吊车|达州市吊车|竹海吊装';
$cfg_description = '大竹县竹海吊装服务有限公司是集起重、吊装、租凭于一体的服务型公司。我司备有8~220吨吊车和起重设备，为您提供最优质吊装服务。热忱欢迎新老客户惠顾！';
$cfg_beian = 'Empty';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
...
$banquan = '版权所有 Copyright © 大竹县竹海吊装服务有限公司 2014-2017 All Rights Reserved';
?>